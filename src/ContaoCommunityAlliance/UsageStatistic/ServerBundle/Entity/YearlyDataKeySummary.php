 ...
 *
 * @ORM\Table(name="summary_data_key_yearly")
 * @ORM\Entity(repositoryClass="ContaoCommunityAlliance\UsageStatistic\ServerBundle\Repository\YearlyDataKeySummaryRepository")
 */
class YearlyDataKeySummary
{
